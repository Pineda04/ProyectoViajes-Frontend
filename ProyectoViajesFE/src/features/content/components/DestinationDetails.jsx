...
export const DestinationDetails = () => {
  ...
  const currentPoints = destination?.data?.pointsInterest.slice(indexOfFirstPoint, indexOfLastPoint);
  const totalPages = Math.ceil(destination?.data?.pointsInterest.length / pointsPerPage);
      ...
      <div className="container mx-auto px-4 md:px-8 xl:px-16">
        <div className="bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="p-6 space-y-6">
            ...
            {/* Puntos de interés */}
            {destination.data?.pointsInterest && destination.data.pointsInterest.length > 0 ? (
              <div>
                ...
                <div className="mt-8 flex justify-center">
                  <Pagination
                    ...
                    handlePreviousPage={() => handleCurrentPage(currentPage - 1)}
              ...
              <p className="text-white text-center mt-4">No hay puntos de interés disponibles para este destino.</p>
            )}
          </div>
        </div>
      </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
          <div className="relative">
            <button className="absolute top-0 right-0 text-white text-2xl p-4" onClick={closeModal}>
              ×
            </button>
            <img
              src={currentImage}
