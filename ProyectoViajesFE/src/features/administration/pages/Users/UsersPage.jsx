...
export const UsersPage = () => {
  ...
  const loadData = useUsersStore((state) => state.loadData);
  const nextPage = useUsersStore((state) => state.nextPage);
  const previousPage = useUsersStore((state) => state.previousPage);
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                ...
                {userToDelete?.firstName}? Todos los datos relacionados se
      ...
      <div className="mt-6 sm:flex sm:items-center sm:justify-between">
        <div className="text-sm text-gray-800 dark:text-gray-800">
          ...
          <span className="font-medium text -gray-700 dark:text-gray-800">
            {usersData.currentPage} de {usersData.totalPages}
          </span>
        </div>
